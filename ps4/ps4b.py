...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(string.ascii_lowercase)):
            ...
            shifted_letter = string.ascii_lowercase[(i + shift) % 26]
            shift_dict[letter] = shifted_letter

        for i in range(len(string.ascii_uppercase)):
            letter = string.ascii_uppercase[i]
            shifted_letter = string.ascii_uppercase[(i + shift) % 26]
            shift_dict[letter] = shifted_letter
        ...
        for word in self.message_text.split():
            ...
            for character in word:
                if character.isalpha():
                    shifted_word += self.build_shift_dict(shift)[character]
                else:
                    shifted_word += character

            shifted_words.append(shifted_word)

        shifted_message_text = " ".join(shifted_words)
...
if __name__ == '__main__':
    ...
    print("Best shift:", story.decrypt_message()[0])
    print("Unencrypted story:", story.decrypt_message()[1])
