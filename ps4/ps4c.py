...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for vowel in VOWELS_LOWER:
            idx = VOWELS_LOWER.index(vowel)
            transpose_dict[vowel] = vowels_permutation[idx]
            transpose_dict[vowel.upper()] = vowels_permutation[idx].upper()
        ...
        for word in self.message_text.split():
            ...
            for character in word:
                if character.isalpha():
                    substituted_word += transpose_dict[character]
                else:
                    substituted_word += character

            substituted_words.append(substituted_word)

        encrypted_message = " ".join(substituted_words)
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        best_vowel_permutation = ""
        max_valid_words = 0

        for vowel_permutation in get_permutations(VOWELS_LOWER):
            ...
            if valid_words > max_valid_words:
                ...
                best_vowel_permutation = vowel_permutation
